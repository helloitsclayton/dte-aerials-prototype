...
This is work done in 2021 as part of a planned update to the WSU Library's [DTE Aerials portal](https://digital.library.wayne.edu/dte_aerial/index.html), in order to provide a more usable interface than the current linked PDFs.
